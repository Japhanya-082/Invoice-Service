...
public final class SecurityUtils {
	...
	public static Long getCurrentAdminId() {
		...
		if (auth != null && auth.getDetails() instanceof Long adminFromDetails) {
			return adminFromDetails;
		}
	...
	public static void assertOwnedByCurrentTenant(Long resourceAdminId) {
		...
		if (resourceAdminId == null || !current.equals(resourceAdminId)) {
			throw new SecurityIntegrityException("Cross-tenant access denied: resource adminId=" + resourceAdminId
	...
	public static final class SecurityIntegrityException extends RuntimeException {
		public SecurityIntegrityException(String message) {
			super(message);
		}
	}
}
